...
namespace RemotePC8801
{
    static class Const
    {
        ...
        public static string SectorReadStatements { get { return ":PRINT \"%%%\";:a=VARPTR(#0):FOR I=0 to 255:V=PEEK(a+i):T$=chr$(V)+\" \"+CHR$((V+&H20) and &hFF):N=(V<=&h20)*-1:L=N+1:PRINT MID$(T$,N+1,L);:NEXT:PRINT"; } }
